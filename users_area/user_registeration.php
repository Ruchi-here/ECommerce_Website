        ...
        <div class="row d-flex align-tems-center justify-content-center">
            <div class="col-lg-12 col-xl-6">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <!-- user address field -->
                    <div class="form-outline mb-4">
                        <label for="user_useraddr" class="form-label">Address</label>
                        <input type="text" id="user_useraddr" class="form-control" placeholder="Enter your address" autocomplete="off" required="required" name="user_useraddr">
                    </div>
                    <!-- user contact number -->
                    <div class="form-outline mb-4">
...
if (isset($_POST['user_register'])){
    ...
    $user_useraddr = $_POST['user_useraddr'];
    ...
    ('$user_username', '$user_email', '$hash_password', '$user_image', '$user_ip', '$user_useraddr','$user_contact')";
